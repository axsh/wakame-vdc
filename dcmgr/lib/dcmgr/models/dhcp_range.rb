...
module Dcmgr::Models
  ...
  class DhcpRange < BaseNew
    ...
    # Query ranges which exist between begin_u32 and end_u32.
    # Assume: 192.168.0.0/24: 10-20, 30-40, 50-60
    # included_ranges("192.168.0.30", "192.168.0.70")
    #   => 192.168.0.30-40, 192.168.0.50-60
    def_dataset_method(:included_ranges) {|begin_u32, end_u32|
      self.filter("range_begin >= ? AND range_end <= ?", begin_u32, end_u32)
    }
