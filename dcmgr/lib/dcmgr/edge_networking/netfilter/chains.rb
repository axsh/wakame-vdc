...
module Dcmgr::EdgeNetworking::Netfilter::Chains
  ...
  module Factory
    ...
    def newchain(layer, suffix, table = :filter)
      ...
      Dcmgr::EdgeNetworking::Netfilter::Chains.const_get("#{layer}Chain").new("#{CHAIN_PREFIX}_#{suffix}", table)
    end
  ...
  module Inbound
    F = Dcmgr::EdgeNetworking::Netfilter::Chains::Factory
    class << self
