    ...
    module Netfilter
      ...
      class NetfilterCache
        ...
        def add_network_mode(network)
          ...
          network[:network_mode_class] = Dcmgr::EdgeNetworking::NetworkModes.get_mode(network[:network_mode], true)
        end
        ...
        def add_vnic_to_security_group(vnic_id,group_id)
          ...
          vnic = result[:vnic]
          @cache[:security_groups][group_id][result[:node_id] == @node.node_id ? :local_vnics : :foreign_vnics][vnic_id] = vnic
