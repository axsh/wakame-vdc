...
module Dcmgr
  module NodeModules
    ...
    class LegacyNetfilter < Isono::NodeModules::Base
      ...
      initialize_hook do
        ...
        if Dcmgr.conf.verbose_netfilter_cache
        ...
        @worker_thread.pass {
          ...
          @task_manager.apply_tasks([Dcmgr::EdgeNetworking::Tasks::DebugIptables.new]) if Dcmgr.conf.debug_iptables
