...
module Dcmgr::NodeModules
  ...
  class ServiceNatbox < Isono::NodeModules::Base
    ...
    def create_flow(match = {}, actions = {})
      Dcmgr::EdgeNetworking::OpenFlow::Flow.new(natbox_conf.ovs_flow_table, natbox_conf.ovs_flow_priority,
    ...
    def inner_dc_network_name
      natbox_conf.inside_dc_network.name
    end

    def natbox_conf
      Dcmgr::Configurations.natbox
    end
  end
