  ...
  module NodeModules
    ...
    class ServiceOpenFlow < Isono::NodeModules::Base
      ...
      def add_instance_now port
        ...
        # Testing guest -> *
        openflow_controller.install_local_icmp          port.port_info.number, mac_lease, ip_lease
        openflow_controller.install_local_transport 6,  port.port_info.number, mac_lease, ip_lease
        openflow_controller.install_local_transport 17, port.port_info.number, mac_lease, ip_lease
      end
