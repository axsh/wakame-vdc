  ...
  module NodeModules
    ...
    class ServiceOpenFlow < Isono::NodeModules::Base
      ...
      def add_instance_now port
        ...
        logger.info "mac: #{port.port_info.hw_addr.to_s} <=> #{port.mac}"
        logger.info "ip: #{port.ip}"
        ...
        openflow_controller.install_route         port.port_info.number, port.mac, port.ip
        openflow_controller.install_arp_antispoof port.port_info.number, port.mac, port.ip
      end
      ...
      def delete_instance_now port
        ...
        openflow_controller.remove_route         port.port_info.number, port.mac, port.ip
        openflow_controller.remove_arp_antispoof port.port_info.number, port.mac, port.ip
      end
