...
module Dcmgr
  module NodeModules
    ...
    class ServiceOpenFlow < Isono::NodeModules::Base
      ...
      # events.
      def delete_openflow_instance(vif_map, viftable_map)
        logger.info "Deleting OpenFlow instance: uuid:#{vif_map[:uuid]} mac:#{vif_map[:mac]} ipv4:#{vif_map[:ipv4]}."

        openflow_controller.remove_route         vif_map[:mac], vif_map[:ipv4]
        openflow_controller.remove_arp_antispoof vif_map[:mac], vif_map[:ipv4]
      ...
      def delete_openflow_by_instance_id(inst_id)
        ...
        delete_openflow_instance vif_map, viftable_map
      end
