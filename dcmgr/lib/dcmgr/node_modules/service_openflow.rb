...
module Dcmgr::NodeModules
  ...
  class ServiceOpenFlow < Isono::NodeModules::Base
    ...
    def create_network network_map
      ...
      network = switch[1].networks[network_id] = Dcmgr::VNet::OpenFlow::OpenFlowNetwork.new(switch[1].datapath, network_id)
      ...
      if network_map[:dns_server] and !network_map[:dns_server].empty?
        ...
        network.services[:dns].ip = network.services[:dhcp].ip
      end
      ...
      if !network_map[:physical_network][:interface].nil?
