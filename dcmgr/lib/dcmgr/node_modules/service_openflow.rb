...
module Dcmgr::NodeModules
  ...
  class ServiceOpenFlow < Isono::NodeModules::Base
    ...
    def create_network network_map
      ...
      if network_map[:dhcp_server] and !network_map[:dhcp_server].empty?
      ...
      if network_map[:dns_server] and !network_map[:dns_server].empty?
      ...
      network.services[:dhcp].install(network)
      ...
      if !network.virtual
        ...
        if network.services.has_key?(:metadata_server)
          if network.services[:metadata_server].ip.to_s == Isono::Util.default_gw_ipaddr.to_s
            network.services[:metadata_server].install(network, Dcmgr::VNet::OpenFlow::OpenFlowController::OFPP_LOCAL, @openflow_controller.local_hw)
          end
        end
