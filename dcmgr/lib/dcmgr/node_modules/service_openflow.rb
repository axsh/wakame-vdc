...
module Dcmgr::NodeModules
  ...
  class ServiceOpenFlow < Isono::NodeModules::Base
    ...
    def add_eth_now switch, port
      ...
      if network.services.has_key?(:metadata_server) and network.services[:metadata].ip.to_s != Isono::Util.default_gw_ipaddr.to_s
        network.services[:metadata].request_mac(switch, network, port)
      end
    end
