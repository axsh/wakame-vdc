...
module Dcmgr::NodeModules
  ...
  class ServiceOpenFlow < Isono::NodeModules::Base
    ...
    def add_eth switch, port
      ...
      if Dcmgr::VNet::OpenFlow::OpenFlowNetwork.add_eth_port(port.datapath.datapath_id, port.port_info.number)
        port.datapath.add_flows(Dcmgr::VNet::OpenFlow::OpenFlowNetwork.physical_flood_flows(port.datapath.datapath_id))
      end
