    ...
    class ServiceOpenFlow < Isono::NodeModules::Base
      ...
      def add_eth_now port
        ...
        port.lock.synchronize {
          ...
          # logger.debug "network physical: #{network.inspect}."

          # network.add_port port_number, true
          # openflow_controller.update_network network.id

          # openflow_controller.install_eth network.id, port, mac_lease, ip_lease
      ...
      def add_instance port
        ...
        EventMachine.add_timer(5) { worker_thread.pass { add_instance_now port } }
      end
      ...
      #   # openflow_controller.networks.clear
      ...
      def get_network_from_id network_id
        return openflow_controller.networks[network_id] if openflow_controller.networks.has_key? network_id
      ...
      def get_network_from_map network_map
        if openflow_controller.networks.has_key? network_map[:id]
          openflow_controller.networks[network_map[:id]]
        else
          create_network network_map
        end
      end
      ...
      def create_network network_map
        ...
        throw "Network already created" if openflow_controller.networks.has_key? network_id and not openflow_controller.networks[network_id].nil?
        ...
        if not network_map[:ipv4_gw].nil?
          ...
          # Do more here...
          network = openflow_controller.install_physical_network network_id
          ...
          network = openflow_controller.install_virtual_network(network_id, openflow_controller.local_hw, dhcp_ip)
