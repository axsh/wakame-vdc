  ...
  module NodeModules
    ...
    class ServiceOpenFlow < Isono::NodeModules::Base
      ...
      def add_instance_now port
        ...
        openflow_controller.install_static_d_transport 17, port_number, mac_lease, ip_lease, 53, ip_map[:network][:dns_server]
        openflow_controller.install_static_d_transport 17, port_number, mac_lease, ip_lease, 67, ip_map[:network][:dhcp_server]
        openflow_controller.install_static_d_transport 17, port_number, mac_lease, ip_lease, 68, ip_map[:network][:dhcp_server]
