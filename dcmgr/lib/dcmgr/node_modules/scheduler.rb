    ...
    class Scheduler < Isono::NodeModules::Base
      ...
      def schedule_instance(instance_id)
        ...
        instance.volumes_dataset.filter_by_state(Const::Volume::STATE_SCHEDULING).each { |vol|
          logger.info("Scheduling volume devices for #{instance.canonical_uuid}: #{vol.canonical_uuid}")
          ...
          logger.info("#{vol.canonical_uuid} is a #{vol.volume_type} located at #{vol.storage_node.canonical_uuid}")
        }
