...
module Dcmgr
  module NodeModules
    ...
    class OpenFlowController < Trema::Controller
      ...
      def remove_route hw, ip
        # MAC address based routing to instance.
        @ovs_ofctl.del_flow "priority=#{1},table=#{@@mac_route_table},dl_dst=#{hw}"
      end
      ...
      def remove_arp_antispoof hw, ip
        # Require correct ARP source IP/MAC from instance, and protect the instance IP from ARP spoofing.
        # @ovs_ofctl.del_flow "table=#{@@arp_antispoof_table},arp,arp_sha=#{hw},nw_src=#{ip}"
