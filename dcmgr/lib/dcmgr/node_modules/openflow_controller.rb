      ...
      def packet_in datapath_id, message
        ...
        if message.ipv4? and message.udp?
          ...
          if message.udp_src_port == 68 and message.udp_dst_port == 67 # and message.ipv4_daddr.to_s == "10.100.0.1"
            ...
            logger.debug "DHCP: message_type:#{message_type.inspect}."
            ...
            if message_type[0].payload[0] == $DHCP_MSG_DISCOVER
              ...
              dhcp_out.options << DHCP::MessageTypeOption.new(:payload => [ $DHCP_MSG_ACK ])
            else
            ...
            logger.debug "DHCP send: output:#{dhcp_out.inspect}."
