...
#
    ...
    class OpenFlowSwitch
      ...
      def features_reply message
        ...
        flows << ["priority=#{1},table=#{@@load_dest_table},dl_dst=#{local_hw.to_s}", "load:#{OpenFlowController::OFPP_LOCAL}->NXM_NX_REG0[],resubmit(,#{@@send_src_table})"]
      ...
      def features_reply message
        ...
        message.ports.each do | each |
          if each.number == OFPP_LOCAL
            switches.first[1].local_hw = each.hw_addr
