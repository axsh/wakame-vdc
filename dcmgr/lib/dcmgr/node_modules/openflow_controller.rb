  ...
  module NodeModules
    ...
    class OpenFlowController < Trema::Controller
      ...
      def install_icmp port, hw, ip, icmp_type, icmp_code
        ...
        learn_outgoing_match = "priority=#{2},table=#{@@load_dest_table},#{match_type},NXM_OF_IN_PORT[],NXM_OF_ETH_SRC[],NXM_OF_ETH_DST[],NXM_OF_IP_SRC[],NXM_OF_IP_DST[]"
        learn_outgoing_actions = "output:NXM_NX_REG0[]"

        learn_incoming_match = "priority=#{2},table=#{@@load_dest_table},#{match_type},NXM_OF_IN_PORT[]=NXM_NX_REG0[0..15],NXM_OF_ETH_SRC[]=NXM_OF_ETH_DST[],NXM_OF_ETH_DST[]=NXM_OF_ETH_SRC[],NXM_OF_IP_SRC[]=NXM_OF_IP_DST[],NXM_OF_IP_DST[]=NXM_OF_IP_SRC[]"
