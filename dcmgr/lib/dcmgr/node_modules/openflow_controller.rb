...
module Dcmgr
  module NodeModules
    ...
    class OpenFlowController < Trema::Controller
      ...
      def start
        logger.debug "OpenFlowController Thread Object Id: #{Thread.current}."
      end
      ...
      def features_reply message
        ...
        @ovs_ofctl.add_flows_from_list networks[1].generate_flood_flows
      ...
      def install_virtual_network network_id
        ...
        logger.info "installed virtual network: network_id:#{network_id}"
      end
