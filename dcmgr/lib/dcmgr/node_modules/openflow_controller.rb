...
#    class OpenFlowHelper < Isono::NodeModules::Base
    class OpenFlowHelper
      include Dcmgr::Logger
      include Dcmgr::Helpers::NicHelper

      # config_section do
      #   desc "configuration file for of helper..."
      # end
      
      # initialize_hook do
      #   logger.info "initialize_hook for of helper..."
      # end
    ...
    class OpenFlowController < Trema::Controller
      ...
      def initialize node
        ...
        @of_helper = OpenFlowHelper.new(node)
      ...
      def start
        ...
        #   # inst_map = @of_helper.create_instance_map
        #   #logger.info "OpenFlowController Thread Object Id: #{Thread.current} finished start."
        #   self.print_foo
        # }
      end
      ...
      def switch_ready datapath_id
        ...
        #   logger.info "EM thread #{Thread.current}: switch_ready thread tasklet."
