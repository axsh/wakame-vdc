  ...
  module NodeModules
    ...
    class OpenFlowController < Trema::Controller
      ...
      def features_reply message
        ...
        flows << ["priority=#{2},in_port=#{1}",  "resubmit(,#{@@group_incoming_table})"]
        ...
        flows << ["priority=#{0},table=#{@@mac_route_table}", "output:#{1}"]
        ...
        flows << ["priority=#{0},table=#{@@group_incoming_table}", "output:#{1}"]
        ...
        flows << ["priority=#{0},table=#{@@load_dest_table}", "load:#{1}->NXM_NX_REG0[],resubmit(,#{@@send_src_table})"]
        ...
        flows << ["priority=#{1},table=#{@@arp_antispoof_table},arp,in_port=#{1}", "resubmit(,#{@@arp_route_table})"]
        ...
        flows << ["priority=#{0},table=#{@@arp_route_table},arp", "output:#{1}"]
        ...
        flows << ["priority=#{4},table=#{@@metadata_outgoing_table},in_port=#{1}", "drop"]
        ...
        flows << ["priority=#{4},table=#{@@metadata_incoming_table},tcp,in_port=#{1}", "drop"]
