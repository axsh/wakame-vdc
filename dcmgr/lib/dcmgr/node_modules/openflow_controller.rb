    ...
    class OpenFlowController < Trema::Controller
      ...
      def packet_in datapath_id, message
        ...
        if message.arp?
          ...
          if message.arp_oper == Racket::L2::Ethernet::ARPOP_REQUEST and message.arp_tpa.to_s == port.network.dhcp_ip.to_s
            send_arp(datapath_id, message.in_port, Racket::L2::Ethernet::ARPOP_REPLY, port.network.dhcp_hw.to_s, port.network.dhcp_ip, message.macsa.to_s, message.arp_spa.to_s)
          end
        ...
        if message.ipv4? and message.udp?
          ...
          if message.udp_src_port == 68 and message.udp_dst_port == 67 # and message.ipv4_daddr.to_s == "10.100.0.1"
            ...
            send_udp(datapath_id, message.in_port, port.network.dhcp_hw.to_s, port.network.dhcp_ip, 67, port.mac.to_s, port.ip, 68, dhcp_out.pack)
          end
        end
      end
