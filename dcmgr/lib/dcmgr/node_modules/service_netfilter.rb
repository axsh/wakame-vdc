  ...
  module NodeModules
    ...
    class ServiceNetfilter < Isono::NodeModules::Base
      ...
      initialize_hook do
        ...
        logger.debug("Subscribing to: hva.#{myinstance.node.manifest.node_instance_id}/instance_started")
        event.subscribe("hva.#{myinstance.node.manifest.node_instance_id}/instance_started", '#') do |args|
          @worker_thread.pass {
        ...
        logger.debug("Subscribing to: hva.#{myinstance.node.manifest.node_instance_id}/instance_terminated")
        event.subscribe("hva.#{myinstance.node.manifest.node_instance_id}/instance_terminated", '#') do |args|
          @worker_thread.pass {
