      ...
      def subscribe_to_security_group(group_id)
        ...
        subscribe_to_event("#{group_id}/referencer_added") do |args|
          @worker_thread.pass {
            ...
            @cache.get_local_vnics_in_group(group_id).each { |lvnic|
              @task_manager.apply_vnic_tasks(lvnic,TaskFactory.create_tasks_for_ARP_isolation(lvnic,referencer.values,node))
            }
        ...
        subscribe_to_event("#{group_id}/referencer_removed") do |args|
          @worker_thread.pass {
            ...
            @cache.get_local_vnics_in_group(group_id).each { |lvnic|
              @task_manager.remove_vnic_tasks(lvnic,TaskFactory.create_tasks_for_ARP_isolation(lvnic,referencer.values,node))
            }
