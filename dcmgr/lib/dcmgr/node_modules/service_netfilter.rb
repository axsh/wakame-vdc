      ...
      def subscribe_to_referenced_security_group(ref_group_id)
        ...
        subscribe_to_event("#{ref_group_id}/vnic_left") do |args|
          @worker_thread.pass {
            ...
            if controller.get_local_vnics_in_group(ref_group_id).empty?
              unsubscribe_from_security_group(ref_group_id)
              if controller.get_local_groups_that_reference_group(ref_group_id).empty?
