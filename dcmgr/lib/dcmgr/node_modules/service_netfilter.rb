      ...
      def subscribe_to_referenced_security_group(ref_group_id)
        subscribe_to_event("#{ref_group_id}/vnic_joined") do |args|
          @worker_thread.pass {
            ...
            controller.get_security_groups.each { |group|
              controller.update_security_group(group[:uuid]) unless group[:referenced_groups].find {|ref_group| ref_group[:uuid] == ref_group_id }.nil?
            }
          }
        end
