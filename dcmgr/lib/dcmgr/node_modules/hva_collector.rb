    ...
    class HvaCollector < Isono::NodeModules::Base
      ...
      def get_group_instance_ipv4s(instance_id,set = :inside)
        ...
        inst.netfilter_groups.compact.map { |netfilter_group|
          netfilter_group.instance_netfilter_groups.compact.map { |instance_netfilter_group|
            instance_netfilter_group.instance_dataset.lives.all.compact.map { |instance|
