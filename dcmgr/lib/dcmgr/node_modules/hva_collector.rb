  ...
  module NodeModules
    class HvaCollector < Isono::NodeModules::Base
      ...
      def get_netfilter_data(node_id)
        ...
        local_vnic_maps  = local_vnics_dataset.all.map {|vnic| vnic.to_netfilter_document } 
          ...
          if vnic_map[:security_groups].empty?
            ...
            vnic_map[:security_groups].each { |group_id|
              if security_groups[group_id] == nil
                ...
                security_groups[group_id][:foreign_vnics] = {}
                secg.network_vif_dataset.exclude(:uuid => local_vnics_dataset.select(:uuid)).all.each { |vnic|
                  security_groups[group_id][:foreign_vnics][vnic.canonical_uuid] = vnic.to_netfilter_document
                }
                ...
                secg.referencees.each { |ref|
                  security_groups[group_id][:referencees][ref.canonical_uuid] = {}
                  ref.network_vif_dataset.all.each { |vnic|
                    security_groups[group_id][:referencees][ref.canonical_uuid][vnic.canonical_uuid] = vnic.to_netfilter_document
                  }
                }
                ...
                secg.referencers.each { |ref|
                  security_groups[group_id][:referencers][ref.canonical_uuid] = {}
                  ref.network_vif_dataset.all.each { |vnic|
                    security_groups[group_id][:referencers][ref.canonical_uuid][vnic.canonical_uuid] = vnic.to_netfilter_document
                  }
                }
              end
