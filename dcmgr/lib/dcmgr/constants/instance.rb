...
module Dcmgr::Constants::Instance
  ...
  STATES=[STATE_SCHEDULING,STATE_PENDING,STATE_STARTING,STATE_RUNNING,STATE_SHUTTING_DOWN,STATE_TERMINATED,STATE_HALTING,STATE_HALTED,STATE_STOPPING,STATE_STOPPED].freeze
end
