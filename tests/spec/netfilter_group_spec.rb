...
describe "/api/netfilter_group" do
  it "should test CURD operations for netfilter" do
    ...
    res1 = APITest.create('/netfilter_groups.json', {:name=>'g1', :description=>'g1', :rule => "tcp:22,22,ip4:0.0.0.0"})
    ...
    APITest.create('/netfilter_groups.json', {:name=>'g1', :description=>'g1', :rule => "tcp:22,22,ip4:0.0.0.0"}).success?.should be_false
    APITest.create('/netfilter_groups.json', {:name=>'g2', :description=>'g2', :rule => "tcp:22,22,ip4:0.0.0.0"}).success?.should be_false
    APITest.create('/netfilter_groups.json', {:name=>'g3', :description=>'g3', :rule => "tcp:22,22,ip4:0.0.0.0"}).success?.should be_false
