...
function test_dc_network_help_stderr_to_devnull_success() {
...
function test_dc_network_index() {
...
function test_dc_network_show_no_uuid() {
  extract_args ${namespace} show
  run_cmd ${MUSSEL_ARGS} 2>/dev/null
  assertNotEquals $? 0
}

function test_dc_network_show_uuid() {
...
function test_dc_network_destroy() {
...
function test_dc_network_xcreate() {
